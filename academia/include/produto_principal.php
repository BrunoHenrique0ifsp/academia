...
/* pista do carrossel (conteúdo rolável) */
.carrossel {
    display: flex;
    transition: transform 0.5s ease-in-out;
    /* largura automática baseada no número de slides (não precisa setar fixa) */
}

/* cada slide tem a largura do "viewport" do carrossel e centraliza seu conteúdo */
.slide {
    flex: 0 0 600px;    /* largura fixa do slide = 600px */
    height: 260px;
    display: flex;
...
/* torna o <a> "block" para garantir área clicável */
.slide a {
    display: block;
    width: 100%;
    height: 100%;
...
/* imagem com limites, mantendo proporção e centralizada */
.slide img {
    max-width: 100%;
    max-height: 200px;
    width: auto;
...
function atualizarCarrossel() {
    // cada slide tem 600px (flex-basis), mover por esse valor
